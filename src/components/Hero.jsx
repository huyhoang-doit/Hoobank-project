...
const Hero = () => (
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl-px-0 sm:px-16 px-6`}>
      ...
      <h1 className='flex-1 font-poppins font-semibold ss:text-[68px] ss:leading-[100px] leading-[75px] text-[52px] text-white w-full'>
        Payment Method
      </h1>
    ...
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      <img src={robot} alt="billing-hdi" className='w-full h-full relative z-10' />
